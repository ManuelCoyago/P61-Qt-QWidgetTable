...
Persona::Persona(const QString &nombre, const QString &apellido, const QString &telefono, const QString &email,const QString &edad) :
    m_nombre(nombre),
    m_apellido(apellido),
    m_telefono(telefono),
    m_email(email),
...
const QString &Persona::edad() const {
    return m_edad;
}
